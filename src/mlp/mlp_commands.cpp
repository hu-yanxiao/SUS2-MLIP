...
bool Commands(const string& command, vector<string>& args, map<string, string>& opts)
{
	...
	BEGIN_COMMAND("train",
		...
		"    --env-gate-cutoff-ratio=<double>: override env-gate cutoff as a fraction\n"
		"                                      of max_dist. Must be in (0, 1].\n"
		"    --env-gate-lambda-raw=<double|list>: override env-gate lambda raw values.\n"
		"                                        One value broadcasts to all species;\n"
		"                                        a comma list must match species_count.\n"
