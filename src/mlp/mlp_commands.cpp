...
bool Commands(const string& command, vector<string>& args, map<string, string>& opts)
{
	...
	BEGIN_COMMAND("train",
		...
		"    --type-force-weights=<w1,w2,...>: per-species force residual multipliers.\n"
		"                                      Values are squared in the force loss.\n"
		"    --nonlinear-l2=<double>: group-averaged L2 ridge on nonlinear parameters.\n"
		"                              Groups: shifts, scaling slopes/shifts by block,\n"
		"                              radial basis coeffs by function, and species scale.\n"
		"    --radial-smooth=<double>: H1 smoothness penalty on dR/dr over (0, cutoff).\n"
		"                              Default=1e-6; set 0 to disable.\n"
		"    --radial-smooth-grid=<int>: midpoint quadrature grid for radial smoothness.\n"
		"                                Default=128.\n"
		"    --atomic-energies=<e1,e2,...>: fixed isolated atom energies by species index.\n"
		"                                  Default=off.\n"
